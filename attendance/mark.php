...
try {
    ...
    // ✅ Check existing attendance using PH today date
    $dupStmt = $db->prepare("
        SELECT id, status 
        FROM attendance 
    ...
    if ($existing) {
        ...
        // No record yet — INSERT as present with PH time
